...
values
('Mary Poppins', 'Mary', 'Poppins', 'Nannys Inc', 'Director', 'Childcare', 'poppins@example.com', 'mary@example.com', '+44 1123 4567', '+44 1987 6543', '+44 1876 5432', 'United Kingdom', 'Greater London', 'London', '17 Cherry Tree Lane', 'SE1', 'http://marypoppins.example.com/')
,('Clark Kent', 'Clark', 'Kent', 'Superman Corp', 'Superhero', 'Villain Control Department', 'superman@example.com', 'clark.kent@example.com', '+1 555 2123 4567', '+1 555 2987 6543', '+1 555 2876 5432', 'United States of America', 'Some State', 'Metropolis', '344 Clinton Street', '00000', 'http://superman.example.com/')
,('Peter Pan', 'Peter', 'Pan', 'Lost Boys', 'Leader', 'Fairy Section', 'peter.pan@example.com', 'peter@example.com', '+1 555 3123 4567', '+1 555 3987 6543', '+1 555 3876 5432', 'Neverland Island', 'Neverland State', 'Mermaid Lagoon', 'Rock pool', '00000', 'http://peterpan.example.com/')
;
